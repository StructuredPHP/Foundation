 ...
 * Country Finder
 * 
 * A helper class which helps you gets the country code / name
 * 
 * @author haihao
 *
 */
class CountryFinder extends Object {
	...
	{
		$result = null;
		if(key_exists($code, $this->countries))
			$result =  $this->countries[$code];
		return $result;
	}
	
	/**
	 * Get country code by given name
	 * 
	 * @param string $name
	 * @return string
	 */
